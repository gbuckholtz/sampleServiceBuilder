...
import ca.queensu.res.soar.portlet.model.RegistrationClp;
...
public class ClpSerializer {
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"ca.queensu.res.soar.portlet.model.impl.RegistrationImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"ca.queensu.res.soar.portlet.NoSuchRegistrationException")) {
			return new ca.queensu.res.soar.portlet.NoSuchRegistrationException();
		}
